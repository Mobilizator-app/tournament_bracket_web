...
export const metadata: Metadata = {
  ...
  description: `Privacy Policy for the ${APP_NAME} app.`,
};

export default function PrivacyPage() {
  return (
    <SiteShell>
      <LegalArticle title="Privacy Policy" effectiveDate={LEGAL_EFFECTIVE_DATE}>
        <Section>
          <p>
            {DEVELOPER_NAME} built the {APP_NAME} app as a free app. This SERVICE
            is provided by {DEVELOPER_NAME} at no cost and is intended for use as
            is.
          </p>
          <p>
          ...
          <p>
            ...
            Terms and Conditions, which are accessible at {APP_NAME} unless
        ...
        <Section title="Information Collection and Use">
          ...
          <p>
            ...
            used to identify you. Links to the privacy policy of third-party
        ...
        <Section title="Changes to This Privacy Policy">
          <p>
            ...
            page. This policy is effective as of {LEGAL_EFFECTIVE_DATE}.
          </p>
        </Section>
